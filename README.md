...
![alt text](docs/images/day.png "Day Picker View") ![alt text](docs/images/month.png "Month Picker View") ![alt text](docs/images/year.png "Year Picker View") ![alt text](docs/images/time.png "time Picker View")
